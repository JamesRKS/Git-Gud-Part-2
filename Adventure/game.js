    ...
    function IchabodsRoom(){
        ...
        function Tubes(){
            ...
            //Poke it
             ...
             else if(tubes == "Go to west door" || tubes == "west door" || tubes == "door"){
                 alert("You quietly sneak to the west door, thankfully not getting it's attention, and you enter the next room.");
                 Puzzle();
             }
            
            else if(tubes == "go back" || tubes == "back"){
                Voidroom();
            }
            
            else if(tubes == "inventory"){
               checkInv();
            }
        ...
        function Puzzle(){
            ...
            if(puzzle == "go back" || puzzle == "back"){
                ...
                else if(inventory.knowledgeofbrother == 0){
            ...
            else if(puzzle == "press green button" || puzzle == "green button"){
                alert("Ding Dong! That's wrong.");
                Puzzle();
            }
            
            else if(puzzle == "press red button" || puzzle == "red button"){
             ...
             else if(puzzle == "use hatchet" || puzzle == "hatchet"){
                 if(inventory.hatchet == 1){
        ...
        function Brother(){
            ...
            else if(brother == "go back" || brother == "back"){
                Puzzle();
            }
        ...
        function TrueEnding(){
            alert("You smash the tube with your hatchet, breaking your unconscious brother out of the tube. He is safe. You are safe. END OF PART 1.");
            alert("...");
            alert("ERROR: FILE: PART2.EXE COULD NOT BE FOUND")
            alert("INCOMING MESSAGE FROM TRUBRO325!");
            alert("TRUBRO325: There was... more here, originally");
            alert("TRUBRO325: Someone must have deleted the next part of this game");
            alert("TRUBRO325: I wonder who?");
            alert("TRUBRO325: I swear, if Ichabod took the second part to try and hide the truth...");
            alert("TRUBRO325: Well, I might as well tell you what would've happened in Part 2");
            alert("TRUBRO325: It would be a few weeks later, Ichabod's brother would visit Imagin again");
            alert("TRUBRO325: He would find the building from the first part, The Artist Tower, under attack");
            alert("TRUBRO325: Why is it under attack?");
            alert("TRUBRO325: Well... because-");
            alert("CONNECTION TERMINATED. SYSTEMS SHUTTING DOWN.");
            Terminate();
        }
